  ...
  return (
    <>
      <header className="sticky top-0 z-50 border-b border-stone-200 bg-white">
        <nav className="mx-auto grid max-w-7xl grid-cols-[1fr_auto_1fr] items-center px-6 py-5 lg:px-10">
          ...
          <div className="hidden md:flex">
            <Link
              ...
              className="text-[11px] font-medium uppercase tracking-[0.2em] text-stone-700 transition hover:text-black"
            >
          ...
          >
            <span className="font-serif text-2xl font-light tracking-[0.32em] text-stone-900 sm:text-[26px]">
              UNIQUE FACTORY
            </span>
            <span className="mt-1.5 text-[10px] font-medium tracking-[0.35em] text-stone-500">
              BERLIN
            </span>
          </Link>
          ...
          <div className="flex items-center justify-end gap-5">
            <a
              href="#kontakt"
              className="hidden text-[11px] font-medium uppercase tracking-[0.2em] text-stone-700 transition hover:text-black md:inline"
            >
              Kontakt
            </a>
            <Link
              ...
              className="text-[10px] font-semibold tracking-[0.2em] text-stone-400 transition hover:text-stone-900"
            >
              {locale === "de" ? "EN" : "DE"}
            </Link>
            <button
              onClick={() => setCartOpen(true)}
              className="relative cursor-pointer text-stone-700 transition hover:text-black"
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="absolute -right-1.5 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-stone-900 px-1 text-[9px] font-semibold text-white">
                  {totalItems}
                </span>
              )}
            </button>
            <button
              className="cursor-pointer text-stone-700 md:hidden"
        ...
        {mobileOpen && (
          <div className="border-t border-stone-200 px-6 py-4 md:hidden">
            <Link
              href="/curtain-configurator"
              className="block py-2 text-[11px] font-medium uppercase tracking-[0.2em] text-stone-700"
